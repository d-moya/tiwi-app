...
def muro_servicio_view(request):
    return render(request, 'publicar/preferencias_tutoria.html')

def muro_servicio_view(request):
    return render(request, 'publicar/preferencias_ayudas.html')

def muro_servicio_view(request):
    return render(request, 'publicar/preferencias_prestamo.html')